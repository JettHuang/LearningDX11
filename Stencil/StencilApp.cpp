...
class MirrorApp : public FD3DApp
{
public:
...
MirrorApp::MirrorApp(HINSTANCE hInstance)
	: FD3DApp(hInstance), mRoomVB(0), mSkullVB(0), mSkullIB(0), mSkullIndexCount(0), mSkullTranslation(0.0f, 1.0f, -5.0f),
...
bool MirrorApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/checkboard.dds", NULL, &mFloorDiffuseMapSRV, 0, NULL));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/brick01.dds", NULL, &mWallDiffuseMapSRV, 0, NULL));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/ice.dds", NULL, &mMirrorDiffuseMapSRV, 0, NULL));
