...
CrateApp::CrateApp(HINSTANCE hInstance)
	: FD3DApp(hInstance), mBoxVB(0), mBoxIB(0), mDiffuseMapSRV(0), mEyePosW(0.0f, 0.0f, 0.0f),
...
bool CrateApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/WoodCrate01.dds", NULL, &mDiffuseMapSRV, 0, NULL));
