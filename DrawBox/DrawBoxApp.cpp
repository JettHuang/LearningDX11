...
BoxApp::BoxApp(HINSTANCE hInstance)
	: FD3DApp(hInstance), mBoxVB(0), mBoxIB(0), mFX(0), mTech(0),
...
void BoxApp::BuildFX()
{
	...
	HRESULT hr = D3DX11CompileEffectFromFile(L"FX/color.fx", 0, 0, shaderFlags, 0, md3dDevice, &mFX, &compilationMsgs);
