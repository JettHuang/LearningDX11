//***************************************************************************************
// ShadowsDemo.cpp by Frank Luna (C) 2011 All Rights Reserved.
//
...
class ShadowsApp : public FD3DApp
{
public:
...
bool ShadowsApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/floor.dds", NULL, &mStoneTexSRV, 0, NULL));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/bricks.dds", NULL, &mBrickTexSRV, 0, NULL));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/floor_nmap.dds", NULL, &mStoneNormalTexSRV, 0, NULL));

	HR(CreateDDSTextureFromFile(md3dDevice,
		L"Textures/bricks_nmap.dds", NULL, &mBrickNormalTexSRV, 0, NULL));
